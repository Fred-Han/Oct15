...
namespace Lean.Touch
{
	...
	//	RecordRotationTOUCH recordRotationTOUCH ; 
	...
	//	Debug.Log (ScreenPosition); 
			...
			RotationListTOUCH.RotationLogTOUCH[RotationListTOUCH.RotationLogTOUCH.Count - 1].qRotation.x = ScreenPosition.x;
			RotationListTOUCH.RotationLogTOUCH[RotationListTOUCH.RotationLogTOUCH.Count - 1].qRotation.y = ScreenPosition.y;

			RotationListTOUCH.RotationLogTOUCH[RotationListTOUCH.RotationLogTOUCH.Count - 1].deltaTime = Age;

	//		Debug.Log (RotationListTOUCH.RotationLogTOUCH[RotationListTOUCH.RotationLogTOUCH.Count - 1].qRotation.x); 


			RotationListTOUCH.Save(Path.Combine(Application.dataPath, "Data/"+"TOUCH.xml"));
